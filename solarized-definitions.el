...
(defun solarized-color-definitions (mode)
  (flet ((find-color (name)
    ...
    (let ((base03    (find-color 'base03))
          ...
          (org1      (find-color 'base2))
          (org2      (find-color 'base1))
          (org3      (find-color 'base00))
          (org4      (find-color 'base01))
          (org5      (find-color 'base01))
          (org6      (find-color 'base01))
          (org7      (find-color 'base01))
          (org8      (find-color 'base01)))
      (when (eq 'light mode)
      ...
      `((;; basic
         ...
         (org-level-1 ((t (:foreground ,org1))))
         (org-level-2 ((t (:foreground ,org2))))
         (org-level-3 ((t (:foreground ,org3))))
         (org-level-4 ((t (:foreground ,org4))))
         (org-level-5 ((t (:foreground ,org5))))
         (org-level-6 ((t (:foreground ,org6))))
         (org-level-7 ((t (:foreground ,org7))))
         (org-level-8 ((t (:foreground ,org8))))
         ;; show-paren
